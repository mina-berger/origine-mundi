 ...
 * @author hiyamamina
 */
public class Parte027ID extends ParteTaleae {
    Integer end; 
    public Parte027ID(Mensa mensa, Integers ids, int talea_primo, int length) {
        this(mensa, ids, talea_primo, length, null);
    }
    public Parte027ID(Mensa mensa, Integers ids, int talea_primo, int length, Integer end) {
