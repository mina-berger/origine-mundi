...
public class RealTimeSequencer extends AbstractMidiDevice implements Sequencer, AutoConnectSequencer {
  ...
  /**
   * Event Dispatcher thread. Should be using a shared event dispatcher instance
   * with a factory in EventDispatcher
   */
 ...
 /*
  ...
  private static class RealTimeSequencerInfo extends MidiDevice.Info {
    ...
    private static final String vendor = "Sun Microsystems & Mocha-Java";
  ...
  private class DataPump {
     ...
     * events that are active in noteOnCache array. It is possible, of course,
     * to catch notes from other tracks, but better than more complicated logic
     * to detect which notes are really from this track
     */
    ...
    /**
     * Runtime application of mute/solo: if a track is muted that was previously
     * playing, send note off events for all currently playing notes
     */
