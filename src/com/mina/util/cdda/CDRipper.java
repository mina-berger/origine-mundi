...
public class CDRipper {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty(key, System.getProperty(key) + ":/usr/local/Cellar/cdparanoia/10.2/bin/tritonuscdparanoia");
        System.out.println(System.getProperty(key));
        // /usr/local/Cellar/cdparanoia/10.2/bin/

        int nExternalBufferSize = DEFAULT_EXTERNAL_BUFFER_SIZE;
        int nInternalBufferSize = AudioSystem.NOT_SPECIFIED;

        /**
         * CDROM drive number. Defaults to first drive. [how is the order
         * constituted?] Not used for now. Hardcoded default to /dev/cdrom.
         */
        int nDrive = 0;
