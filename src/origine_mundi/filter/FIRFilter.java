 ...
 * @author Mina
 */
public class FIRFilter implements Constantia, Legibilis {
    ...
    public FIRFilter(Legibilis legibilis, double cutoff_freq, boolean lpf, boolean hamming, Aestimatio volume){
