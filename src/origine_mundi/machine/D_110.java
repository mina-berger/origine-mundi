...
public class D_110 extends Roland {
    ...
    private static CodeValue PARTIAL_STRUCTURE = new CodeValue("partial structure model",
            new KV(0, "S & S Mix"), 
    ...
    private static DataBlock PARTIAL_BLOCK = new DataBlock("partial model",
    ...
    public static void main(String[] arg) throws Exception {
        ...
        SysexDataModel model = new SysexDataModel("temporary tone",
            ...
            new DataBlock("common",
                ...
                new BitArray("partial mute", 4, true),
