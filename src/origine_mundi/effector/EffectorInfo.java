 ...
 */
package origine_mundi.effector;
...
public abstract class EffectorInfo implements ProcessorInfo {
    ...
    public static Legibilis getEffector(Legibilis legibilis, EffectorInfo info){
        ...
        if(info instanceof ThruInfo){
            ...
            return new Mora(legibilis, mora_info.duration, mora_info.times, mora_info.feedback);
        }else if(info instanceof ChorusInfo){
            ChorusInfo chorus_info = (ChorusInfo)info;
            return new Chorus(legibilis, chorus_info.depth, chorus_info.frequency, chorus_info.dry_out, chorus_info.wet_out);
        }
        return legibilis;
