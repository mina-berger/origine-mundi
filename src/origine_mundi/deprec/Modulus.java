...
import origine_mundi.deprec.Tabula.Collocatio;
...
public abstract class Modulus {
    public abstract Punctum capio(Punctum lectum, OrbisPuncti in, OrbisPuncti ex);
    ...
    public static class ModCapiens extends Modulus {
        ...
        @Override
        public Punctum capio(Punctum lectum, OrbisPuncti in, OrbisPuncti ex) {
